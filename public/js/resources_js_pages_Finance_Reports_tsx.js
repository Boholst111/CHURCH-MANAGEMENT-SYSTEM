"use strict";
(self["webpackChunkchurch_management_system"] = self["webpackChunkchurch_management_system"] || []).push([["resources_js_pages_Finance_Reports_tsx"],{
...
/* harmony import */ var _components_ui_modal__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../components/ui/modal */ "./resources/js/components/ui/modal.tsx");
...
/**
 * Helper function to download PDF reports with proper validation and error handling
 * @param reportType - Backend report type identifier
 * @param startDate - Report start date (YYYY-MM-DD)
 * @param endDate - Report end date (YYYY-MM-DD)
 * @param reportTitle - Human-readable report title for filename
 * @throws Error with specific message for different failure modes
 */
function downloadPdfReport(_x, _x2, _x3, _x4) {
  return _downloadPdfReport.apply(this, arguments);
}
function _downloadPdfReport() {
  _downloadPdfReport = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(reportType, startDate, endDate, reportTitle) {
    var response, contentType, blob, url, a, _t3;
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.p = _context3.n) {
        case 0:
          _context3.p = 0;
          _context3.n = 1;
          return fetch("/api/reports/".concat(reportType, "?start_date=").concat(startDate, "&end_date=").concat(endDate), {
            method: 'GET',
            headers: {
        ...
        case 9:
          // Create download URL
          url = window.URL.createObjectURL(blob); // Create temporary anchor element for download
          a = document.createElement('a');
          a.href = url;
          a.download = "".concat(reportType, "-").concat(new Date().toISOString().split('T')[0], ".pdf");
          // Append to DOM, trigger download, then cleanup
          document.body.appendChild(a);
          a.click();
          // Cleanup: remove anchor and revoke URL
          document.body.removeChild(a);
          window.URL.revokeObjectURL(url);
          // Download successfully triggered
          _context3.n = 13;
          break;
        case 10:
          _context3.p = 10;
          ...
          if (!(_t3.message.includes('fetch') || _t3.message.includes('NetworkError'))) {
            _context3.n = 11;
            break;
          }
...
var Reports = function Reports() {
  ...
  var handleSubmitGenerate = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(e) {
      var startDate, endDate, today, ranges, range, reportTypeMap, reportType, errorMessage, _t;
        ...
        while (1) switch (_context.p = _context.n) {
          ...
          case 1:
            ...
            if (reportConfig.dateRange !== 'custom') {
              ...
              range = ranges[reportConfig.dateRange];
              if (range) {
            ...
            reportType = reportTypeMap[selectedReport.id];
            if (reportType) {
              _context.n = 2;
              break;
            }
          ...
          case 2:
            _context.n = 3;
            return downloadPdfReport(reportType, startDate, endDate, selectedReport.title);
          case 3:
            // Only show success message after download is complete
            alert("".concat(selectedReport.title, " generated successfully!"));
          ...
          case 4:
            _context.p = 4;
            _t = _context.v;
            console.error('Error generating report:', _t);
            errorMessage = _t instanceof Error ? _t.message : 'Failed to generate report. Please try again.';
            alert(errorMessage);
          case 5:
            _context.p = 5;
            setGenerating(false);
    ...
    return function handleSubmitGenerate(_x5) {
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
    ...
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("h2", {
        ...
        children: "Generate and view financial reports"
      })]
    }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", {
      className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6",
      children: financialReports.map(function (report) {
        return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components_ui_card__WEBPACK_IMPORTED_MODULE_2__.Card, {
          ...
          children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", {
            ...
            children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_ui_button__WEBPACK_IMPORTED_MODULE_3__.Button, {
              ...
              children: "Generate"
            }), report.lastGenerated && (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_ui_button__WEBPACK_IMPORTED_MODULE_3__.Button, {
              variant: "outline",
              size: "sm",
              ...
              onClick: function () {
                var _onClick = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
                  var reportTypeMap, reportType, today, lastMonthStart, lastMonthEnd, startDate, endDate, errorMessage, _t2;
                  return _regenerator().w(function (_context2) {
                    while (1) switch (_context2.p = _context2.n) {
                      case 0:
                        ...
                        reportType = reportTypeMap[report.id];
                        if (reportType) {
                          _context2.n = 1;
                          break;
                        }
                      ...
                      case 1:
                        // Use last month as default date range for "View Last"
                        today = new Date();
                        ...
                        endDate = lastMonthEnd.toISOString().split('T')[0]; // Download the PDF using the helper function
                        _context2.n = 2;
                        return downloadPdfReport(reportType, startDate, endDate, report.title);
                      case 2:
                        _context2.n = 4;
                        break;
                      case 3:
    ...
    }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_ui_modal__WEBPACK_IMPORTED_MODULE_4__.Modal, {
