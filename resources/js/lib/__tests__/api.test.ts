...
describe('API Client Configuration', () => {
  ...
  describe('Session Timeout Handling', () => {
    ...
    it('redirects to login page on 401 response', async () => {
      ...
      // Verify redirect (window.location.href is set to '/login')
  ...
  describe('API Configuration', () => {
    it('uses relative API URL for same-origin requests', () => {
      // After Laravel Mix migration, API uses relative URL
